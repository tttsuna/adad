...
__webpack_require__(/*! @rails/activestorage */ "./node_modules/@rails/activestorage/app/assets/javascripts/activestorage.js").start(); //require("channels").start()


__webpack_require__(/*! users.js */ "./app/javascript/users.js").start(); // Uncomment to copy all static images under ../images to the output folder and reference
...
/* WEBPACK VAR INJECTION */(function($) {var working = false;
$('.login').on('submit', function (e) {
  e.preventDefault();
  cosole.log("hhogehoge");
  if (working) return;
  working = true;
  var $this = $(this),
...
/******/ });
//# sourceMappingURL=application-0eaf6bfd42f077c05d69.js.map